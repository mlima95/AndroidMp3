package com.example.androidmp3.dataloader;
...
public class SongLoader {
    ...
    public static Music findSongById(long id) {
        ...
        if (musicCursor != null && musicCursor.moveToFirst()) {
            ...
            do {
                ...
                if (isMusic != 0) {
                    ...
                    Music song = new Music(id, title, path, artist, artistId, album, albumId, duration, date);
